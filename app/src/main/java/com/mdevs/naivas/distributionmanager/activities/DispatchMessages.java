...
import com.mdevs.naivas.financemanager.activities.Reply;
...
public class DispatchMessages extends AppCompatActivity implements FeedBackAdapter.MessageClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispatch_messages);
    ...
    private void getFeedBackData() {
        ...
        String url = "http://android.officialm-devs.com/naivas/android/feedback?dispatch_manager=1";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, response -> {
            try {
                ...
                feedBackAdapter.setOnItemClickListener(DispatchMessages.this);
    ...
    public void onClick(int position) {
        Intent intent = new Intent(DispatchMessages.this, Reply.class);
